...
function initForma() {
  ...
  const TERM_ALIASES = {
    ...
    "loading spinner": ["spinner", "loading indicator", "loader", "spinning loader", "spinning loading indicator", "progress spinner", "loading wheel", "spinner indicator", "circular loader", "spin loader", "rotating loader", "busy indicator", "busy spinner", "activity indicator", "wait indicator"],
