...
CANONICAL_DESCRIPTIONS = {
    "Off-Canvas Drawer": "A panel sliding in from the viewport edge to reveal navigation or secondary content.",
    "Glassmorphic Popover": "A frosted-glass overlay with backdrop blur, used for menus or contextual panels.",
    "Masonry Grid": "An asymmetric grid layout where items pack together based on varying heights.",
    "Sticky Navbar": "A navigation bar that remains fixed at the top while the page scrolls.",
    "Modal Overlay": "A semi-transparent layer covering the screen to display blocking content like dialogs.",
    "Skeleton Loader": "A placeholder shape that mimics content layout while data is loading.",
    "Tab Panel": "A horizontal switcher with multiple panels, only one visible at a time.",
    "Accordion": "A vertical stack of collapsible sections that expand and collapse on click.",
    "Toast Notification": "A small ephemeral message appearing briefly to confirm actions or surface alerts.",
    "Breadcrumb Navigation": "A trail of links showing the user's path through the app's hierarchy.",
    "Tooltip": "A small floating label that appears on hover to explain an element.",
    "Dropdown Menu": "A list of options that appears below a trigger when clicked.",
    "Progress Bar": "A linear indicator showing completion percentage of a task or process.",
    "Bottom Sheet": "A panel sliding up from the bottom edge, common on mobile for actions or details.",
    "Confirmation Dialog": "A modal asking the user to confirm or cancel a destructive action.",
    "Search Bar": "A text input with search icon, often with autocomplete suggestions.",
    "Toggle Switch": "A two-state switch that animates between on and off, used for boolean settings.",
    "Loading Spinner": "An animated indicator showing that content or an action is in progress.",
    "Floating Action Button": "A circular button anchored to a corner that triggers the primary screen action.",
    "Hero Section": "A prominent top-of-page section featuring a headline, subhead, and call-to-action.",
    "Card Grid": "A responsive grid of card components used to display lists of similar items.",
    "Pagination Control": "Numbered controls for navigating through long lists or search results.",
    "Image Carousel": "A horizontally scrolling row of images with navigation arrows or dots.",
    "Hamburger Menu": "A toggleable icon-triggered menu typically used for mobile navigation.",
    "Data Table": "A structured table with sortable columns, filters, and pagination for displaying records.",
    "Banner": "A wide horizontal strip used for announcements, alerts, or promotional content.",
    "Sidebar Navigation": "A vertical panel of links for primary navigation in dashboards or admin tools.",
    "Footer Section": "A bottom-of-page region containing links, contact info, and legal text.",
    "Step Progress Indicator": "A linear sequence of steps showing user progress through a multi-step flow.",
    "Notification Badge": "A small dot or count indicator overlaid on an icon to show unread items.",
    "Date Picker": "A calendar-based input for selecting a date or date range.",
    "File Upload": "An input that accepts files via click or drag-and-drop with a drop zone.",
    "Rating Stars": "A row of star icons allowing users to rate something on a 1-5 scale.",
    "Color Picker": "A visual input for selecting a color from a swatch, gradient, or hex code.",
    "Range Slider": "A draggable slider for selecting a value or range within numeric bounds.",
    "Form Input Field": "A text input for entering data, with label and validation states.",
    "Login Form": "A form with username and password fields plus a submit action for authentication.",
    "Avatar": "A small circular image or initials representing a user's identity.",
    "Empty State": "A placeholder screen shown when there's no content yet, often with a call-to-action.",
    "Chip Tag": "A small rounded label used for tags, filters, or selected items.",
    "Separator": "A horizontal or vertical line used to divide content sections visually.",
    "Settings Panel": "A grouped form of toggles and inputs for user or app preferences.",
    "Cookie Banner": "A persistent banner asking users to consent to cookie usage.",
    "Comment Thread": "A nested list of user comments with reply, like, and timestamp affordances.",
    "Stats Counter": "A numeric display animating up to a final value, often used in marketing pages.",
    "Testimonial Card": "A card displaying a quote, attribution, and avatar for social proof.",
    "Pricing Card": "A vertical card listing plan features and a call-to-action button.",
    "Activity Feed": "A chronologically ordered list of recent user or system events.",
    "Mega Menu": "A wide multi-column dropdown for navigation in content-heavy sites.",
    "Command Palette": "A keyboard-triggered search input for quickly invoking actions or navigating.",
    "Notification Center": "A panel listing recent notifications, often with read/unread states.",
    "Profile Dropdown": "A user avatar that opens a menu with account, settings, and sign-out options.",
    "OTP Input": "A row of single-character inputs for entering a one-time passcode.",
    "Tag Input": "A text input that converts entries into removable chip tags on enter.",
    "Phone Input": "A specialized input with country code selector and number formatting.",
    "Search Suggestions": "A dropdown of autocomplete suggestions that appears below a search input.",
    "Floating Label Input": "A text input where the label animates to a smaller position when focused.",
    "Switch Group": "A vertical list of labeled toggle switches grouped under a single setting category.",
    "Onboarding Tour": "A guided walkthrough with tooltips highlighting key features for new users.",
    "Password Strength": "A visual indicator showing how strong a typed password is, often as a colored bar.",
}
        ...
        validated.append(
            {
                ...
                "category": "Component",
                "alternatives": [
                    {"term": term, "description": CANONICAL_DESCRIPTIONS.get(term, "")}
