(function() {
  ...
  console.log('[Forma] Initializing with animations...');
  ...
  const TERM_ALIASES = {
    ...
    "sticky navbar": ["sticky header", "fixed navbar", "fixed header", "sticky top bar", "fixed top bar", "sticky navigation", "fixed navigation", "persistent header", "sticky menu", "top navigation bar", "fixed nav", "anchored header", "pinned header", "top nav bar"],
    "modal overlay": ["modal dialog", "modal", "dialog box", "popup modal", "overlay modal", "modal window", "blur effect", "dimmer layer", "dim layer", "faded background", "scrim overlay", "backdrop", "scrim", "alert box", "pop-up window", "popup window", "popup", "pop up", "fade in overlay", "fade-in overlay", "darkened overlay", "fog effect", "fog overlay"],
    ...
    "loading spinner": ["spinner", "loading indicator", "loader", "spinning loader", "spinning loading indicator", "progress spinner", "loading wheel", "spinner indicator", "circular loader", "spin loader", "rotating loader"],
  ...
  function init() {
    ...
    if (!targetTextarea) {
      console.log('[Forma] No textarea found.');
      return;
    }
